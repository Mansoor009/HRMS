...
<div class="sticky">
    <aside class="app-sidebar sidebar-scroll">
        ...
        <div class="main-sidemenu">
            ...
            <div class="sidebar-navs">
                <ul class="nav  nav-pills-circle">
                    ...
                    <li class="nav-item" data-bs-toggle="tooltip" data-bs-placement="top" title=""
                        ...
                        <a class="nav-link text-center m-2" href="<?php echo e(route('logut')); ?>">
            ...
            <ul class="side-menu ">
                <li class="slide">
                    <a class="side-menu__item" href="/mansoor/admin/dashboard.php/"><i
                            class="side-menu__icon fe fe-airplay"></i><span
                            class="side-menu__label">Dashboard</span></a>
                </li>
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="<?php echo e(route('admin.dashboard')); ?>"><i
                            class="side-menu__icon fe fe-box"></i><span class="side-menu__label">All Employee</span></a>
                </li>
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="<?php echo e(route('admin.leave.dashboard')); ?>"><i
                            class="side-menu__icon fe fe-award "></i><span
                            class="side-menu__label">Leaves(Employee)</span></a>
                </li>
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="<?php echo e(route('admin.holiday.view')); ?>"><i
                            class="side-menu__icon fe fe-layers "></i><span class="side-menu__label">Holidays</span></a>
                </li>
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="<?php echo e(route('admin.attendance.list')); ?>"><i
...
<?php /**PATH C:\laragon\www\HRMS\resources\views\layouts\admin_sidebar.blade.php ENDPATH**/ ?>