...
<aside class="app-sidebar sidebar-scroll">
    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu ">
            <li class="slide">
                <a class="side-menu__item" href="<?php echo e(route('member.dashboard')); ?>"><i class="side-menu__icon fe fe-airplay"></i><span class="side-menu__label">Attendance</span></a>
            </li>
            <li class="slide">
                <a class="side-menu__item" data-bs-toggle="slide" href="<?php echo e(route('leave.dashboard')); ?>"><i class="side-menu__icon fe fe-box"></i><span class="side-menu__label">Leave Dashboard</span></a>
            </li>
...
<?php /**PATH C:\laragon\www\HRMS\resources\views\layouts\member_sidebar.blade.php ENDPATH**/ ?>