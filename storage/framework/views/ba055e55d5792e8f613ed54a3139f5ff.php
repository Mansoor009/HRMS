                ...
                <div class="main-card-signin d-md-flex">
                    ...
                    <div class="sign-up-body wd-md-50p">
                        <div class="main-signin-header">
                            ...
                            <form id="newPass">
                                <input type="text" hidden value="<?php echo e($token); ?>">
    ...
    <script>
        ...
        $("#newPass").validate({
            submitHandler: function() {
                ...
                $.ajax({
                    url: '<?php echo e(route('reset.password.post')); ?>',
                    type: "post",
                    data: data,
                    beforeSend: function() {
                    ...
                    success: function(res) {
                        if (res.status === true) {
                            ...
                            setTimeout(() => {
                                window.location = '<?php echo e(route('login', 'token')); ?>';
                            }, 500);
                        }
                    },
...
<?php /**PATH C:\laragon\www\HRMS\resources\views\new_password.blade.php ENDPATH**/ ?>