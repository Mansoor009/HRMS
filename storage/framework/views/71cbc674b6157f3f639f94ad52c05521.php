...
<?php $__env->startSection('title', 'Attendance List'); ?>
                        ...
                        <thead>
                            <tr>
                                ...
                                <?php for($i = 1; $i <= $numberOfDays; $i++): ?>
                                    <th data-val = '<?php echo e($i); ?>'><?php echo e($i); ?></th>
                                <?php endfor; ?>
                            </tr>
                        </thead>
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attend): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td><?php echo e($attend['id']); ?></td>
                                    <td><?php echo e($attend['user_name']); ?></td>
                                    <?php for($i = 1; $i <= $numberOfDays; $i++): ?>
                                        <?php
...
<?php $__env->startPush('script'); ?>
    <script>
        $('.fa-check').click(function(e) {
            ...
            $.ajax({
                type: "get",
                url: '<?php echo e(route('emp.duration', '')); ?>' + "/" + id,
                data: {
                    date: date,
                },
...
<?php echo $__env->make('layouts.master_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\HRMS\resources\views\admin\attendance-list.blade.php ENDPATH**/ ?>